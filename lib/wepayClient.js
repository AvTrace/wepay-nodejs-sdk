...
WepayClient.prototype.call = (type, params, riskToken, clientIP) => {
  const url = endpoints[type];
  if(!url) throw new Error('endpoint does not exist');
...
WepayClient.prototype.get_api_version = () => settings.apiVersion;
